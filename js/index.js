...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const sections = document.querySelectorAll(
    ".intro-section, .links-section, .features-section, .contact-section"
  );
  ...
  features.forEach((feature, index) => {
    ...
    feature.addEventListener("mousemove", function (e) {
      ...
      feature.style.transform = `translate(${x * 0.1}px, ${
        y * 0.1
      }px) translateY(-10px) scale(1.05)`;
    });
    ...
    heroLogo.addEventListener("click", function () {
      ...
      setTimeout(() => {
        this.style.animation =
          "logoFloat 3s ease-in-out infinite, spin 0.8s ease";
      }, 10);
